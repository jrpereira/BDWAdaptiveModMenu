...
assert(ordered[2].dmmSetting.kemKeybind and ordered[2].dmmSetting.minimum==0
 and ordered[2].dmmSetting.maximum==254 and ordered[2].dmmSetting.kemPairId=='PrimaryXMode'
 and ordered[2].dmmSetting.kemTabsWidth==220)
